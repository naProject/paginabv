<?php 
$evl_show_rss = evl_get_option('evl_show_rss','1');
...
$evl_pinterest = evl_get_option('evl_pinterest','');
?>   

<ul class="sc_menu">

<?php if ($evl_show_rss == '1') { ?>   
...
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_facebook == "" ) $evl_facebook = $default_facebook;echo esc_attr($evl_facebook);?>" class="tipsytext" id="facebook" original-title="Facebook"><i class="fa fa-facebook"></i></a></li><?php } else { ?><?php } ?>

<?php 
  if (!empty($evl_twitter_id)) { ?>
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_twitter_id == "" ) $evl_twitter_id = $default_twitter_id;echo esc_attr($evl_twitter_id);?>" class="tipsytext" id="twitter" original-title="Twitter"><i class="fa fa-twitter"></i></a></li><?php } else { ?><?php } ?>

<?php 
  if (!empty($evl_googleplus)) { ?>
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_googleplus != "" ) echo $evl_googleplus; ?>" class="tipsytext" id="plus" original-title="Google Plus"><i class="fa fa-google-plus-square"></i></a></li><?php } else { ?><?php } ?>
...
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_youtube != "" ) echo $evl_youtube; ?>" class="tipsytext" id="youtube" original-title="YouTube"><i class="fa fa-youtube"></i></a></li><?php } else { ?><?php } ?>

<?php 
  if (!empty($evl_flickr)) { ?>
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_flickr != "" ) echo $evl_flickr; ?>" class="tipsytext" id="flickr" original-title="Flickr"><i class="fa fa-flickr"></i></a></li><?php } else { ?><?php } ?>
...
<?php 
  if (!empty($evl_pinterest)) { ?>
<li><a target="_blank" href="<?php $options = get_option('evolve');if ($evl_pinterest != "" ) echo $evl_pinterest; ?>" class="tipsytext" id="pinterest" original-title="Pinterest"><i class="fa fa-pinterest"></i></a></li><?php } else { ?><?php } ?>
